  ...
  return (
    <>
      ...
      <section className="relative min-h-[92vh] flex items-center justify-center overflow-hidden">
        <Image src="/images/aahero1.jpg" alt="Fishing on the Sebastian Water with Captain Sonny Richards" fill priority fetchPriority="high" quality={85} className="object-cover object-center" sizes="100vw" />
